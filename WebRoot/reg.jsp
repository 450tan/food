    	...
    	<div class="zc">
            ...
            <h3>欢迎注册</h3>
       	  	   <s:form action="customer/customer_reg" method="post">
						<s:textfield name="customer.name" placeholder="帐号" cssClass="kuang_txt phone"></s:textfield>
						<s:password name="customer.password" placeholder="密码" cssClass="kuang_txt possword"></s:password>
						<s:textfield name="customer.address" placeholder="地址" cssClass="kuang_txt phone"></s:textfield>
                        <s:textfield name="yanz" placeholder="验证码" cssClass="kuang_txt yanzm"></s:textfield>
