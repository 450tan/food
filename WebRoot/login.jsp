				...
				<div class="bj_bai">
					...
					<div>
					 <s:form action="customer/customer_login" method="post">
						<s:textfield name="customer.name" label="账号" cssClass="kuang_txt"></s:textfield>
						<s:password name="customer.password" label="密码" cssClass="kuang_txt"></s:password>
